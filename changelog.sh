...
ARG_UNRELEASED_ONLY=""
if [ ! -z "$INPUT_UNRELEASED_ONLY" ]; then
  ARG_UNRELEASED_ONLY="--unreleased-only"
fi

# build changelog
echo "Running: github_changelog_generator $ARG_USER $ARG_PROJECT $ARG_RELEASE_BRANCH $ARG_BASE $ARG_OUTPUT $ARG_TOKEN $ARG_SINCE_TAG $ARG_DUE_TAG $ARG_EXCLUDE_TAGS $ARG_EXCLUDE_LABELS $ARG_DATE_FORMAT $ARG_FUTURE_RELEASE $ARG_ISSUE_LINE_LABELS $ARG_GITHUB_SITE $ARG_GITHUB_API $ARG_EXCLUDE_TAGS_REGEX $ARG_UNRELEASED_ONLY"
github_changelog_generator $ARG_USER $ARG_PROJECT $ARG_RELEASE_BRANCH $ARG_BASE $ARG_OUTPUT $ARG_TOKEN $ARG_SINCE_TAG $ARG_DUE_TAG $ARG_EXCLUDE_TAGS $ARG_EXCLUDE_LABELS $ARG_DATE_FORMAT $ARG_FUTURE_RELEASE $ARG_ISSUE_LINE_LABELS $ARG_GITHUB_SITE $ARG_GITHUB_API $ARG_EXCLUDE_TAGS_REGEX $ARG_UNRELEASED_ONLY
